package gabby.paba.recyclerview
...
class detWayang : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val _detFotoWayang: ImageView = findViewById(R.id.detFotoWayang)
        val _detNamaWayang: TextView = findViewById(R.id.detNamaWayang)
        val _detDetailWayang: TextView = findViewById(R.id.detDetailWayang)
